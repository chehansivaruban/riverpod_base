...
class Failure with _$Failure {
  ...
  // const factory Failure.deepLink(DeepLinkFailure failure) = _DeepLinkFailure;

  // const factory Failure.giveFeedback(GiveFeedbackFailure failure) =
  //     _GiveFeedbackFailure;
